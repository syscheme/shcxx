...
const ZQ::SNMP::ModuleMIB::MIBE gTblMib_rtspProxy[] = {
	...
	{".3.1.100", "sopTable" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100)
	{".3.1.100.1", "sopEntry" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1)
	{".3.1.100.1.1", "sopIndex" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopIndex(1)
	{".3.1.100.1.10", "sopUsedBandwidth" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopUsedBandwidth(10)
	{".3.1.100.1.11", "sopMaxBandwidth" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopMaxBandwidth(11)
	{".3.1.100.1.12", "sopActiveSession" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopActiveSession(12)
	{".3.1.100.1.13", "sopMaxSession" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopMaxSession(13)
	{".3.1.100.1.14", "sopLocalSession" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopLocalSession(14)
	{".3.1.100.1.15", "sopVolume" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopVolume(15)
	{".3.1.100.1.2", "sopName" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopName(2)
	{".3.1.100.1.3", "sopStreamer" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopStreamer(3)
	{".3.1.100.1.4", "sopStreamService" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopStreamService(4)
	{".3.1.100.1.5", "sopStatus" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopStatus(5)
	{".3.1.100.1.6", "sopPenalty" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopPenalty(6)
	{".3.1.100.1.7", "sopSessionUsed" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopSessionUsed(7)
	{".3.1.100.1.8", "sopSessionFailed" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopSessionFailed(8)
	{".3.1.100.1.9", "sopErrorRate" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).rtspProxy(1000).rtspExtNGOD(3).rtspNGODAttr(1).sopTable(100).sopEntry(1).sopErrorRate(9)

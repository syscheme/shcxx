...
const ZQ::SNMP::ModuleMIB::MIBE gTblMib_edgeFe[] = {
	...
	{".2.1.102.1", "efeCacheReset" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheReset(1)
	{".2.1.102.2", "efeCacheMemHits" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheMemHits(2)
	{".2.1.102.3", "efeCacheDiskHits" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDiskHits(3)
	{".2.1.102.4", "efeCacheDiskMisseds" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDiskMisseds(4)
	{".2.1.102.5", "efeCacheDirTab" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5)
	{".2.1.102.5.1", "efeCacheDir" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1)
	{".2.1.102.5.1.1", "ecdPath" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdPath(1)
	{".2.1.102.5.1.10", "ecdWriteLatAvg" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdWriteLatAvg(10)
	{".2.1.102.5.1.11", "ecdWriteLatMax" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdWriteLatMax(11)
	{".2.1.102.5.1.2", "ecdLRU" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdLRU(2)
	{".2.1.102.5.1.3", "ecdReaders" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdReaders(3)
	{".2.1.102.5.1.4", "ecdWriters" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdWriters(4)
	{".2.1.102.5.1.5", "ecdMaxMBps" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdMaxMBps(5)
	{".2.1.102.5.1.6", "ecdFreeMB" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdFreeMB(6)
	{".2.1.102.5.1.7", "ecdTotalMB" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdTotalMB(7)
	{".2.1.102.5.1.8", "ecdReadLatAvg" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdReadLatAvg(8)
	{".2.1.102.5.1.9", "ecdReadLatMax" }, //{enterprises}.zqInteractive(22839).tianShanComponents(4).tianShanService(1).edgeFe(3400).edgeFeApp(2).edgeFeAttr(1).efeCache(102).efeCacheDirTab(5).efeCacheDir(1).ecdReadLatMax(9)

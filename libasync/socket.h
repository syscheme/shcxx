...
#ifdef ZQ_OS_LINUX
		//get the sent pos,
		// completeSize鎋凡瀹_鎋_鏮_size
		//杩_錩_浠ュ__send/recv鏮_buffer涓_帮糭錩_瑁瑰凡缁_send/recv涓_開ㄥ__鏮_buffer
		//int pos 鎋綺錩哄__鎋帮糭杈_錩簊end/recv涓_錩_buffer鏮_錩_開_開_
		int  getCompletePos(const AsyncBufferS& bufs, int completeSize, int& pos);

		//瀹_鏮癰ufs錩_iovec鎋扮籣鏮_杞_?


		//startNum琛ㄧずbufs開_瑕_send/recv鏮_璧峰buf
		//pos 琛ㄧず璧峰buf宸茬籣send/recv鏮_浣_缃糭涔_灏辨__send/recv鏮_璧峰浣_缃__	
		//maxNum 鎋_瀹_iov鎋扮籣澶у癬锛_開叉瓒_鏮_
